...
Files::ERRORS Files::loadCameraFile(std::string cameraName, json *data)
{
    ...
    std::filesystem::path filePath = paths::userDevicesPath / cameraName.append(".json");
...
Files::ERRORS Files::saveCameraFile(std::string cameraName, json *data)
{
    ...
    std::filesystem::create_directories(paths::userDevicesPath); // Directory SHOULD exist before opening an ofstream
    std::filesystem::path filePath = paths::userDevicesPath / cameraName.append(".json");
...
std::string_view Files::to_string(ERRORS err) noexcept
{
    ...
    case ERRORS::FILE_EMPTY:
        return "file is empty";
    case ERRORS::UNABLE_TO_OPEN:
        return "couldn't open the file";
    case ERRORS::NO_PERMISSION:
        return "file access is limited";
    default:
